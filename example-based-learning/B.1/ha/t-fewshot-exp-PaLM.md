...
### EXPLANATION
The rules illuminate the meeting room with fixtures that are not the primary ones. The first rule turns on the desktop light when occupancy is detected at the meeting room. The second rule turns off the desktop light when no occupancy is detected at the meeting room and no occupancy is detected at the desktop.
## END
