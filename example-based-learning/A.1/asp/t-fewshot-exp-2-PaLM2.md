...
### EXPLANATION
The first rule turns on the kitchen light when occupancy is detected if the lighting is insufficient. The second rule turns off the light when there is no occupancy, as it is not necessary for the room to be illuminated when there is no one in it.
## END
